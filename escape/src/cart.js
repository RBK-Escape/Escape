      ...
      <div class="row">
        <div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5 ">
            ...
            <table class="table">
              ...
              <tbody>
                {items.map((item) => {
                  ...
                  <td class="border-0 align-middle"><a class="text-dark" onClick={() => {removeItem(item.id); setId(item.id) }}><i class="fa fa-trash"></i></a></td>
                </tr>           
                    )
                })}
              </tbody>
          ...
          <div className="d-flex justify-content-between">
            ...
            <td>
            <button className="btn btn-dark rounded-pill py-2 " onClick={()=>{ emptyCart(); setId('all') }}>
                  Clear Cart
                </button>
                </td>
                </div>
